...
<html>
    ...
    <body>
	    ...
	    <div class="form-group">
            <label for="varchar">Matpel <?php echo form_error('matpel') ?></label>
            <input type="text" class="form-control" name="matpel" id="matpel" placeholder="Matpel" value="<?php echo $matpel; ?>" />
        </div>
